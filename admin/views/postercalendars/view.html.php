...
/**
 * PosterCalendars View
 *
 * @since  0.0.1
 */
class PosterCalendarViewPosterCalendars extends JViewLegacy
{
	/**
	 * Display the PosterCalendars view
	 *
	...
	{		
		...
		$context = "postercalendar.list.admin.postercalendar";
	...
	{
		$title = JText::_('COM_POSTERCALENDAR_MANAGER_POSTERCALENDARS');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_POSTERCALENDAR_ADMINISTRATION'));
	}
}